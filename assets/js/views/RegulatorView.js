...
app.RegulatorView = Backbone.View.extend({
      tagName   : 'li',
      className : 'panel',
    	...
    	render: function() {
          this.collection1 =new Backbone.Collection (this.collection1.where({regulator :this.model.get('name') }));
          var data = {};
          data.id = this.model.get('id');
          data.name = this.model.get('name');
          data.no = this.collection1.length;
          console.log(data);
          this.template =  _.template($('#regulator').html()),
