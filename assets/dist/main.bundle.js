...
var DocumentuploadComponent = /** @class */ (function () {
    ...
    DocumentuploadComponent.prototype.specialFileEvent = function (event) {
        ...
        this.http.post("http://localhost:1337/uploadSpecialFile", formData).subscribe(function (result) {
