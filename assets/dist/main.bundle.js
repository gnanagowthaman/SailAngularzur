...
var DocumentuploadComponent = /** @class */ (function () {
    ...
    DocumentuploadComponent.prototype.onSelectRootDoc = function (args) {
        ...
        if (stTestDocName === 1) {
            ...
            var headers = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["c" /* HttpHeaders */]();
            headers = headers.set('Content-Type', 'application/json; charset=utf-8');
            var myparams = new __WEBPACK_IMPORTED_MODULE_3__angular_common_http__["d" /* HttpParams */]();
            ...
            this.http.get('http://localhost:1337/spdocument', { headers: headers, params: myparams }).subscribe(function (data) {
                _this.inPath = data;
