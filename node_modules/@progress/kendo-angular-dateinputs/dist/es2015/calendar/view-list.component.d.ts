import { ChangeDetectorRef, EventEmitter, OnChanges, OnDestroy, AfterViewChecked, AfterViewInit, TemplateRef } from '@angular/core';
...
export declare class ViewListComponent implements OnChanges, OnDestroy, AfterViewInit, AfterViewChecked {
    ...
    constructor(bus: BusViewService, cdr: ChangeDetectorRef, intl: IntlService, dom: DOMService);
    ngOnInit(): void;
