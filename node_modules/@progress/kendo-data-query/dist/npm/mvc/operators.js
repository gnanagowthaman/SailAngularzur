...
var typedFormatter = function (encode) { return runOrEmpty(hasField, funcs_1.either(filter_serialization_common_1.isStringValue, funcs_1.compose(filterFormatter, filter_serialization_common_1.quote, encode ? filter_serialization_common_1.encodeValue : funcs_1.identity), dateFormatter)); };
var join = function (_a) {
    var logic = _a.logic;
    return "~" + logic + "~";
};
var serialize = function (encode) { return filter_serialization_common_1.serializeFilters(function (filter) { return funcs_1.either(filter_descriptor_interface_1.isCompositeFilterDescriptor, serialize(encode), typedFormatter(encode))(filter); }, join); };
