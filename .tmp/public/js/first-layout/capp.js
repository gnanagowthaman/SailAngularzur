...
$(window).resize(function() {
   hamburguerMenu_Close();
    ...
    $('#archiveAlerts').on('click', function(e) {
        app.ClientAppRouter.page = 'alerts';        
        console.log("Alerts: ", app.ClientAppRouter.page);
     //    history.pushState('alerts', null, location.href);    
     routeCalled('archiveAlerts');          
        appRouter.navigate("archiveAlerts", {trigger: true, replace: true});
    }); 
...
var count = 0; 
var previousPageName ="userDashboard";
